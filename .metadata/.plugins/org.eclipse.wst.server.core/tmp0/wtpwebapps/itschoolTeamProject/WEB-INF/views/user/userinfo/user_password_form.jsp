...
<body>
	...
	<form style="width: 70%; margin: 0 auto;" id="user-password-form">
		<div>
			<h4 style="text-align: center; margin-bottom: 30px">비밀번호변경</h4>
		</div>
		<div class="form-row">
			<div class="form-group col-md-12">
				<label>아이디</label> <input type="email" class="form-control" id="id"
					placeholder="id" name="id" required="true"
					data-parsley-type="email" value="${sessionid}" readonly="readonly"
		...
		<div class="form-row">
			<div class="form-group col-md-12">
				<label>새로운 비밀번호</label> <input type="password" class="form-control"
					placeholder="New password" id="new-password" name="newpassword" 
					required="true" data-parsley-error-message="새 비밀번호를 입력하세요!"
					data-parsley-errors-container="div[id='newError']">
			</div>
		</div>
		<div class="row">
			<div class="col-sm-12">
				<div id="newError" style="color: #FF0000; text-align: center;"></div>
			</div>
		</div>
		<button type="button" class="btn btn-block thr-back"
			id="userinfo-password" style="margin-bottom: 30px">비밀번호 변경하기</button>
	</form>
	<!-- Modal -->
