...
<script type="text/javascript">
	function fn_paging(page){
		$(location).attr('href',"reviewList?curPage="+page);
	}
		...
		<table class="table table-hover">
			...
			<thead>
				<tr>
					...
					<th style="text-align: center">도서</th>
			...
			<tbody>
				...
				<tr>
					...
					<td style="text-align: center">${board.bookname}</td>
					<td style="text-align: center"><img src="resources/images/icons/star.PNG" style="width: 20px; height: 20px"> ${board.score}</td>
					<td style="text-align: center">
					<a href="reviewDetailForm?code=${board.code}&boardname=${board.boardname}">${board.title}</a>
					</td>
					<td style="text-align: center">${board.username}</td>
					<td style="text-align: center">${board.time}</td>
