...
<div class="container" style="padding:40px 0;">
	...
	<ul class="pagination justify-content-center">
		<c:if test="${pageNum != 1}">
		<li class="page-item">
			<a class="page-link" href="eventList?pageNum=${pageNum - 1}">Previous</a>
		</li>
		</c:if>
		<c:forEach var="page" begin="1" end="${pageCount}">
		<li class="page-item <c:if test="${pageNum == page}"> active</c:if>">
			<a class="page-link" href="eventList?pageNum=${page}">
			${page}
		...
		<li class="page-item">
			<a class="page-link" href="eventList?pageNum=${pageNum + 1}">Next</a>
		</li>
		</c:if>
	</ul>
