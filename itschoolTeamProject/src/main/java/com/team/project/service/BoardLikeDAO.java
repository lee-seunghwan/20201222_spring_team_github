...
public interface BoardLikeDAO {
	 ...
	 * @param BoardLike - code와  userid만을 사용하여 확인합니다.
	 * @return 이미 평가했다면 1이상, 아니라면 0이 반환됩니다.
	 * @author : 김영호
	 * @date : 2018. 8. 24. 오후 2:29:24
	*/
	public BoardLike duplicateCheck(BoardLike boardLike);

	/**
	 * 평가를 추가합니다.
	 * @param BoardLike 싹다 담으세요
	 * @author : 김영호
	...
	*/
	...
	/**
	 * 평가를 취소합니다.
	 * @param boardcode, boardname과 userid만 담으세요
	 * @author : 김영호
	 * @date : 2018. 8. 24. 오후 2:31:05
	*/
	 ...
	 *  db에서 좋아요카운트를 1 제거하고 싫어요 카운트를 1 올리며 기존 BoardLike의 eval을 '싫어요'로 수정합니다.
	 *  인자로 받은 값이 그 반대일경우 반대로 수행합니다.
	 * @param BoardLike
	 * @author : 김영호
	 * @date : 2018. 8. 27. 오전 9:47:34
	 */
	public void toggleBothLikeAndDislike(BoardLike boardLike);
