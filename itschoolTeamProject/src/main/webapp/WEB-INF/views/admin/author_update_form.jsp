...
<body>
	<form id="author_update_form" name="author_update_form" method="post" action="authorupdate" data-parsley-validate="true" enctype="multipart/form-data">
		<input type="hidden" id="confirm_yn" value="n">
		<input type="hidden" id="code" name="code" value="${authors.code}" class="form-control">
		<div class="container">
			<div class="row" style="margin-top: 30px">
				<div class="col-md-4"></div>
				<div class="col-md-4" style="text-align: center">
				<a href=#><img id="insertimage" src="resources/images/author/${authors.code}.jpg" title="클릭 후 이미지 변경" alt="클릭 후 이미지 변경" width="120px" height="160px"></a>
				</div>
				<div class="col-md-4"></div>
			</div>
			<div class="row">
			...
			<div class="row">
				...
				<div class="input-group mb-3 col-md-6 ">
					...
					<input type="text" id="authorname" name="name" value="${authors.name}" class="form-control">
				</div>
				<div class="col-md-3"></div>
			</div>
			<div class="row">
				...
				<div class="input-group mb-3 col-md-6 ">
					...
					<input type="text" id="birthyear" name="birthyear" value="${authors.birthyear}" class="form-control">
				</div>
				<div class="col-md-3"></div>
			</div>
			<div class="row">
				...
				<div class="input-group mb-3 col-md-6 ">
					...
					<textarea class="form-control noresize" id="discription" name="discription">${authors.discription}</textarea>
				</div>
				<div class="col-md-3"></div>
			</div>
