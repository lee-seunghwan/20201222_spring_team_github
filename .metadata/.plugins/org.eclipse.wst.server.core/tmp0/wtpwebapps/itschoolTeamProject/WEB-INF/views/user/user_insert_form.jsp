...
<body>
	<form action="userInsert" id="user-insert-form">
		<input type="hidden" id="dup-yn" value="n">
				...
				<div class="col-sm-6">
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="input-group mb-3">
								...
								<button type="button" class="btn btn-primary" id="dup-check">중복여부</button>
							</div>
						</div>
					</div>
					<div class="row">
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="input-group mb-3">
								<div class="input-group-prepend">
									<span class="input-group-text user-form">별명</span>
								</div>
								<input type="text" class="form-control" id="nickname" name="nickname"
									required="true" data-parsley-error-message="별명을 입력하세요!"
					...
					<div class="row" style="margin-bottom: 10px">
						<div class="col-sm-6">
							<button type="button" class="btn pri-back btn-block" id="user-save">확인</button>
						</div>
						<div class="col-sm-6">
